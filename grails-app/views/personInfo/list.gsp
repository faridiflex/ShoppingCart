                ...
                <table>
                    <thead>
                        <tr>
                            ...
                            <g:sortableColumn property="id" title="${message(code: 'personInfo.id.label', default: 'Id')}" />
                        
                            <th><g:message code="personInfo.contactInfo.label" default="Contact Info" /></th>
                    ...
                    <g:each in="${personInfoInstanceList}" status="i" var="personInfoInstance">
                        <tr class="${(i % 2) == 0 ? 'odd' : 'even'}">
                            ...
                            <td><g:link action="show" id="${personInfoInstance.id}">${fieldValue(bean: personInfoInstance, field: "id")}</g:link></td>
                        
                            <td>${fieldValue(bean: personInfoInstance, field: "contactInfo")}</td>
