		...
		<div id="show-buyer" class="content scaffold-show" role="main">
			...
			<ol class="property-list buyer">
				...
				<li class="fieldcontain">
					<span id="loginId-label" class="property-label"><g:message code="buyer.loginId.label" default="Login Id" /></span>
						...
						<span class="property-value" aria-labelledby="loginId-label"><g:fieldValue bean="${buyer}" field="loginId"/></span>
                ...
                <g:if test="${buyer?.dateCreated}">
                    <li class="fieldcontain">
                        <span id="dateCreated-label" class="property-label"><g:message code="buyer.dateCreated.label" default="Date Created" /></span>
				...
				<li class="fieldcontain">
					<span id="profile-label" class="property-label"><g:message code="buyer.profile.label" default="Profile" /></span>
						...
						<span class="property-value" aria-labelledby="profile-label"><g:link controller="buyerProfile" action="show" id="${buyer?.profile?.id}">${buyer?.profile?.encodeAsHTML()}</g:link></span>
			...
			<g:form>
				<fieldset class="buttons">
					...
					<g:link class="edit" action="edit" id="${buyer?.id}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
