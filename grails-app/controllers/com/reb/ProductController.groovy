...
class ProductController {
    ...
    def list = {
        ...
        [productInstanceList: Product.list(params).collectAll {new ProductVo(it)}, productInstanceTotal: Product.count()]
    }
    ...
    def show = {
        ...
        if (!productInstance) {
            ...
            ProductVo productVo = new ProductVo(productInstance)
            [productVo: productVo]
        }
    }
